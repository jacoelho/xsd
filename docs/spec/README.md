...
| --- | --- | --- |
| Schema shape and basic terminology | `01_primer.md` | `internal/compile` |
| Element and attribute declarations, defaults, fixed values, qualification | `02_elements_and_attributes.md` | `internal/compile`, `internal/runtime`, `internal/validate` |
| Complex types, particles, derivation, wildcards, abstract types | `03_complex_types.md` | `internal/compile`, `internal/runtime` |
| `unique`, `key`, `keyref`, selectors, and fields | `04_identity_constraints.md` | `internal/compile`, `internal/validate` |
| Assessment order, `xsi:type`, `xsi:nil`, and validity rules | `05_validation.md` | `internal/validate` |
| Simple types, lexical/value spaces, facets, and whitespace | `06_data_types.md` | `internal/runtime`, `internal/compile` |
| Namespace declarations, form defaults, include/import, and composition | `07_namespaces.md` | `internal/xmlns`, `internal/source`, `internal/compile` |
| Schema components, groups, annotations, notations, and uniqueness | `08_schema_components.md` | `internal/compile`, `internal/runtime` |
