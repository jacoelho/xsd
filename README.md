...
XML documents require one root element. Outside it, only literal XML whitespace, comments, and processing instructions are accepted; CDATA sections and character references are rejected even when they decode to whitespace.
