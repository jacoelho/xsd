...
func validateOccurrenceConstraints(baseMinOcc, baseMaxOcc, restrictionMinOcc, restrictionMaxOcc occurs.Occurs) error {
...
func effectiveParticleOccurrence(baseParticle, restrictionParticle model.Particle) (occurs.Occurs, occurs.Occurs, occurs.Occurs, occurs.Occurs) {
