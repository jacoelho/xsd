...
// CompileContentModel determinizes the model or falls back to an NFA when the DFA is too large.
func CompileContentModel(glu *Glushkov, matchers []runtime.PosMatcher, limits Limits) (Model, error) {
	if glu == nil {
