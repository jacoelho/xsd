...
func mustCompileSchema(t *testing.T, schemaXML string) (*validatorcompile.CompiledValidators, *parser.Schema, *schema.Registry) {
	t.Helper()
	...
	compiled, err := validatorcompile.Compile(resolvedSchema, reg)
	if err != nil {
