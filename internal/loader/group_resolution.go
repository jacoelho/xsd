...
func (l *SchemaLoader) resolveGroupRefsInContentWithVisited(content types.Content, schema *schema.Schema, detector *CycleDetector[types.QName]) error {
...
func (l *SchemaLoader) resolveGroupRefsInModelGroupWithCycleDetection(mg *types.ModelGroup, schema *schema.Schema, detector *CycleDetector[types.QName]) error {
