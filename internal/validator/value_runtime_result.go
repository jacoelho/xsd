...
// ValueState stores derived key data, union-selected actual type data, and facet progress flags.
...
func (s *ValueState) SetKey(kind runtime.ValueKind, key []byte) {
	if s == nil {
		return
	}
	s.key.Kind = kind
...
func (s *ValueState) SetActual(typeID runtime.TypeID, validatorID runtime.ValidatorID) {
	if s == nil {
		return
	}
...
func (s *ValueState) Actual() (runtime.TypeID, runtime.ValidatorID) {
	if s == nil {
		return 0, 0
	}
...
func (s *ValueState) SetPatternChecked(checked bool) {
	if s == nil {
		return
	}
...
func (s *ValueState) EnumChecked() bool {
