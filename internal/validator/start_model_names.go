...
// StartActualElementName formats one actual element name for validation details.
func StartActualElementName(rt *runtime.Schema, sym runtime.SymbolID, nsID runtime.NamespaceID) string {
	if sym != 0 {
...
// ExpectedStartGlobalElements reports the set of declared root element names.
func ExpectedStartGlobalElements(rt *runtime.Schema) []string {
	if rt == nil {
		return nil
	}
