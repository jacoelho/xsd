...
func (r *streamRun) checkFixedValue(actualValue, fixedValue string, textType *grammar.CompiledType, actualNs, fixedNs NamespaceContext) []errors.Validation {
...
func (r *streamRun) fixedValueEqual(actualValue, fixedValue string, textType *grammar.CompiledType, actualNs, fixedNs NamespaceContext) bool {
...
func (r *streamRun) compareFixedValueInUnion(actualValue, fixedValue string, memberTypes []*grammar.CompiledType, actualNs, fixedNs NamespaceContext) (bool, error) {
...
func (r *streamRun) compareFixedValueInUnionTypes(actualValue, fixedValue string, memberTypes []types.Type, actualNs, fixedNs NamespaceContext) (bool, error) {
...
func (r *streamRun) parseUnionValue(value string, memberTypes []*grammar.CompiledType, ns NamespaceContext) (fixedValueParsed, bool) {
...
func (r *streamRun) parseUnionValueTypes(value string, memberTypes []types.Type, ns NamespaceContext) (fixedValueParsed, bool) {
	for _, member := range memberTypes {
		if member == nil {
			continue
		}
...
func (r *streamRun) compareFixedQNameValue(actualValue, fixedValue string, typ types.Type, actualNs, fixedNs NamespaceContext) (bool, error) {
...
func (r *streamRun) compareFixedValueList(actualValue, fixedValue string, listType *grammar.CompiledType, actualNs, fixedNs NamespaceContext) (bool, error) {
...
func (r *streamRun) parseFixedListItem(value string, itemType *grammar.CompiledType, ns NamespaceContext) (fixedValueParsed, error) {
