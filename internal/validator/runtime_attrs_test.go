...
func TestValidateAttributesProhibited(t *testing.T) {
	...
	inputAttrs := []Start{{Sym: ids.attrSymProhibited, NS: ids.nsID, NSBytes: []byte("urn:test"), Local: []byte("prohib")}}
...
func TestValidateAttributesSimpleTypeXsiOnly(t *testing.T) {
	...
	inputAttrs := []Start{{Sym: ids.attrSymDefault, NS: ids.nsID, NSBytes: []byte("urn:test"), Local: []byte("default")}}
...
func TestValidateAttributesDuplicate(t *testing.T) {
	...
	inputAttrs := []Start{{Sym: ids.attrSymDefault, NS: ids.nsID, NSBytes: []byte("urn:test"), Local: []byte("default")}, {Sym: ids.attrSymDefault, NS: ids.nsID, NSBytes: []byte("urn:test"), Local: []byte("default")}}
	_, err := sess.ValidateAttributes(ids.typeBase, inputAttrs, nil)
	if err == nil {
