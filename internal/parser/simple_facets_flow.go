...
func parseFacetsWithPolicy(doc *schemaxml.Document, restrictionElem schemaxml.NodeID, restriction *model.Restriction, st *model.SimpleType, schema *Schema, policy facetAttributePolicy) error {
