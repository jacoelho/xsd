...
func parseAttribute(doc *xmltree.Document, elem xmltree.NodeID, schema *Schema, local bool) (*model.AttributeDecl, error) {
...
func parseAttributeUse(doc *xmltree.Document, elem xmltree.NodeID) (model.AttributeUse, error) {
