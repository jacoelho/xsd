...
func parseAttribute(doc *Document, elem NodeID, schema *Schema, local bool) (*model.AttributeDecl, error) {
...
func parseAttributeUse(doc *Document, elem NodeID) (model.AttributeUse, error) {
