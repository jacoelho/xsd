...
func (l *SchemaLoader) pendingResolutionInputs(sourceKey loadKey) (*schemaEntry, []pendingDirective, *parser.Schema, error) {
...
func (l *SchemaLoader) stagePendingTargets(pendingDirectives []pendingDirective) (map[loadKey]*stagedPendingTarget, error) {
