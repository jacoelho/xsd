...
// LoadConfig describes the root-owned callbacks needed to resolve one directive target.
type LoadConfig[K comparable] struct {
...
func Load[K comparable](cfg LoadConfig[K]) (LoadResult[K], error) {
	if cfg.Resolve == nil {
