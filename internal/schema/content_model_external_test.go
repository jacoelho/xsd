...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="order">
	...
	mustNotValidate(t, engine, `<order><item sku="123-AA"><qty>100</qty></item></order>`, xsderrors.CodeValidationFacet)
	mustNotValidate(t, engine, `<order><item sku="bad"><qty>2</qty></item></order>`, xsderrors.CodeValidationFacet)
	mustNotValidate(t, engine, `<order><item><qty>2</qty></item></order>`, xsderrors.CodeValidationAttribute)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="derived" type="Derived"/>
	...
	mustNotValidate(t, engine, `<derived>red</derived>`, xsderrors.CodeValidationFacet)
	mustNotValidate(t, engine, `<base>blue</base>`, xsderrors.CodeValidationFacet)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	<xs:element name="v" type="Sized"/>
			...
			mustValidate(t, engine, `<v>`+test.valid+`</v>`)
			mustNotValidate(t, engine, `<v>`+test.invalid+`</v>`, xsderrors.CodeValidationFacet)
		})
	}
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
	...
	mustValidate(t, engine, `<v>ab</v>`)
	mustNotValidate(t, engine, `<v>a</v>`, xsderrors.CodeValidationFacet)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="root" type="derived"/>
	...
	mustNotValidate(t, engine, `<root xmlns:f="urn:f" f:a="x"/>`, xsderrors.CodeValidationAttribute)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
	...
	mustNotValidate(t, choiceEngine, `<root><a>x</a><b>y</b></root>`, xsderrors.CodeValidationElement)
	mustNotValidate(t, choiceEngine, `<root/>`, xsderrors.CodeValidationContent)
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
	...
	mustNotValidate(t, allEngine, `<root><d>y</d></root>`, xsderrors.CodeValidationContent)
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
	...
	mustNotValidate(t, engine, `<root><local/><empty/></root>`, xsderrors.CodeValidationElement)
	mustNotValidate(t, engine, `<root xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><empty xsi:nil="true">x</empty></root>`, xsderrors.CodeValidationNil)
	mustNotValidate(t, engine, `<root xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><empty xsi:nil="true"> </empty></root>`, xsderrors.CodeValidationNil)
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root" nillable="true">
	...
	mustNotValidate(t, nilledEngine, `<root xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="true"><required/></root>`, xsderrors.CodeValidationNil)
	...
	mustNotValidate(t, notNillable, `<root xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:nil="false">abc</root>`, xsderrors.CodeValidationNil)
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" targetNamespace="urn:test" xmlns:tns="urn:test">
  <xs:element name="root">
	...
	mustNotValidate(t, other, `<root xmlns="urn:test"><local xmlns=""/></root>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
	...
	mustNotValidate(t, engine, `<root><unknown/></root>`, xsderrors.CodeValidationElement)
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
	...
	mustNotValidate(t, engine, `<root/>`, xsderrors.CodeValidationContent)
}

func TestAnyAttributeRejectsOccurrenceAttributes(t *testing.T) {
	_, err := xsdSchema.Compile(xsdSchema.Options{}, []source.Source{source.Bytes("schema.xsd", []byte(`<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"><xs:element name="root"><xs:complexType><xs:anyAttribute minOccurs="2"/></xs:complexType></xs:element></xs:schema>`))})
	expectCode(t, err, xsderrors.CodeSchemaInvalidAttribute)

	_, err = xsdSchema.Compile(xsdSchema.Options{}, []source.Source{source.Bytes("schema.xsd", []byte(`<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"><xs:element name="root"><xs:complexType><xs:anyAttribute maxOccurs="2"/></xs:complexType></xs:element></xs:schema>`))})
	expectCode(t, err, xsderrors.CodeSchemaInvalidAttribute)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
	...
	mustNotValidate(t, engine, `<root><b>y</b><a>x</a></root>`, xsderrors.CodeValidationElement)
	mustNotValidate(t, engine, `<root><a>x</a></root>`, xsderrors.CodeValidationContent)
}
...
func TestAllModelBeyondBitsetWidth(t *testing.T) {
	...
	missing.WriteString(`</root>`)
	mustNotValidate(t, engine, missing.String(), xsderrors.CodeValidationContent)
	mustNotValidate(t, engine, `<root><e0>x</e0><e0>y</e0></root>`, xsderrors.CodeValidationElement)
}
...
func TestModelGroupSyntaxIsValidated(t *testing.T) {
	...
	for _, test := range tests {
		_, err := xsdSchema.Compile(xsdSchema.Options{}, []source.Source{source.Bytes("schema.xsd", []byte(`<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">`+test.body+`</xs:schema>`))})
...
func TestAnonymousTypeAttributesAreValidated(t *testing.T) {
	...
	if _, err := xsdSchema.Compile(xsdSchema.Options{}, []source.Source{source.Bytes("schema.xsd", []byte(valid))}); err != nil {
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="root" type="derived"/>
	...
	mustNotValidate(t, engine, `<root><a/></root>`, xsderrors.CodeValidationContent)
	mustNotValidate(t, engine, `<root><b/><b/></root>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="root" type="derived"/>
	...
	mustValidate(t, engine, `<root><a/><a/></root>`)
	mustNotValidate(t, engine, `<root><a/><a/><a/></root>`, xsderrors.CodeValidationElement)
	mustNotValidate(t, engine, `<root><b/></root>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" targetNamespace="urn:test" xmlns:t="urn:test" elementFormDefault="qualified">
  ...
  <xs:element name="root" type="t:derived"/>
	...
	mustNotValidate(t, engine, `<root xmlns="urn:test"><annotation/><element/><element/></root>`, xsderrors.CodeValidationElement)
	mustNotValidate(t, engine, `<root xmlns="urn:test"><annotation/><any/></root>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="root" type="derived"/>
	...
	mustValidate(t, engine, `<root><a/></root>`)
	mustNotValidate(t, engine, `<root><a/><a/></root>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="root" type="derived"/>
	...
	mustNotValidate(t, engine, `<root><element/><element/></root>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
	...
	mustNotValidate(t, engine, `<root><foo/><a/><bar/></root>`, xsderrors.CodeValidationElement)
}
...
func TestRequiredGroupRefWithEmptiableChoiceCanBeAbsent(t *testing.T) {
	engine, err := xsdSchema.Compile(xsdSchema.Options{}, []source.Source{source.Bytes("schema.xsd", []byte(`
...
func TestTopLevelGroupDeclarationAttributesAreValidated(t *testing.T) {
	...
	for _, test := range tests {
		_, err := xsdSchema.Compile(xsdSchema.Options{}, []source.Source{source.Bytes("schema.xsd", []byte(`<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">`+test.group+`</xs:schema>`))})
		expectCode(t, err, test.code)
	}
}
...
func TestTopLevelGroupDeclarationChildrenAreValidated(t *testing.T) {
	...
	for _, group := range tests {
		_, err := xsdSchema.Compile(xsdSchema.Options{}, []source.Source{source.Bytes("schema.xsd", []byte(`<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">`+group+`</xs:schema>`))})
		expectCode(t, err, xsderrors.CodeSchemaContentModel)
	}
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="r"><xs:complexType><xs:group ref="g" minOccurs="2" maxOccurs="4"/></xs:complexType></xs:element>
	...
	mustNotValidate(t, engine, `<r><a/><b/></r>`, xsderrors.CodeValidationContent)
	mustNotValidate(t, engine, `<r><a/><b/><a/></r>`, xsderrors.CodeValidationContent)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="r">
	...
	mustNotValidate(t, engine, `<r><x/><a/><b/><a/><b/></r>`, xsderrors.CodeValidationElement)
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="r">
	...
	mustValidate(t, engine, `<r><x/></r>`)
	mustNotValidate(t, engine, `<r><x/><a/></r>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
	...
	mustNotValidate(t, engine, `<root><a>x</a></root>`, xsderrors.CodeValidationContent)
	mustNotValidate(t, engine, `<root><a>x</a><b>y</b></root>`, xsderrors.CodeValidationElement)
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="root">
	...
	mustNotValidate(t, repeating, `<root/>`, xsderrors.CodeValidationContent)
}

func TestInvalidOccurrenceIsSchemaCompileError(t *testing.T) {
	_, err := xsdSchema.Compile(xsdSchema.Options{}, []source.Source{source.Bytes("schema.xsd", []byte(`<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"><xs:element name="r"><xs:complexType><xs:sequence><xs:element name="a" minOccurs="2" maxOccurs="1"/></xs:sequence></xs:complexType></xs:element></xs:schema>`))})
	expectCode(t, err, xsderrors.CodeSchemaOccurrence)
...
func TestCompileOptionsNameAndOccurrenceLimits(t *testing.T) {
	_, err := xsdSchema.Compile(xsdSchema.Options{MaxSchemaNames: 1}, []source.Source{source.Bytes("schema.xsd", []byte(`<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"><xs:element name="root"/></xs:schema>`))})
	...
	_, err = xsdSchema.Compile(xsdSchema.Options{MaxFiniteOccurs: 10}, []source.Source{source.Bytes("schema.xsd", []byte(schema))})
	expectCategoryCode(t, err, xsderrors.CategorySchemaCompile, xsderrors.CodeSchemaLimit)
	...
	_, err = xsdSchema.Compile(xsdSchema.Options{MaxFiniteOccurs: 10}, []source.Source{source.Bytes("schema.xsd", []byte(boundary))})
	if err != nil {
		t.Fatalf("Compile() maxOccurs boundary error = %v", err)
	}

	_, err = xsdSchema.Compile(xsdSchema.Options{MaxContentModelStates: 1}, []source.Source{source.Bytes("schema.xsd", []byte(boundary))})
	expectCategoryCode(t, err, xsderrors.CategorySchemaCompile, xsderrors.CodeSchemaLimit)
	...
	_, err = xsdSchema.Compile(xsdSchema.Options{MaxContentModelStates: 1}, []source.Source{source.Bytes("schema.xsd", []byte(directSequence))})
	expectCategoryCode(t, err, xsderrors.CategorySchemaCompile, xsderrors.CodeSchemaLimit)
	...
	_, err = xsdSchema.Compile(xsdSchema.Options{MaxContentModelStates: 1}, []source.Source{source.Bytes("schema.xsd", []byte(directChoice))})
	expectCategoryCode(t, err, xsderrors.CategorySchemaCompile, xsderrors.CodeSchemaLimit)

	_, err = xsdSchema.Compile(xsdSchema.Options{MaxContentModelStates: 32}, []source.Source{source.Bytes("schema.xsd", []byte(boundary))})
	if err != nil {
	...
	if _, err = xsdSchema.Compile(xsdSchema.Options{}, []source.Source{source.Bytes("schema.xsd", []byte(sharedModels))}); err != nil {
		t.Fatalf("Compile() shared content-model graph error = %v", err)
	}
	_, err = xsdSchema.Compile(xsdSchema.Options{MaxContentModelAnalysisSteps: 4}, []source.Source{source.Bytes("schema.xsd", []byte(sharedModels))})
	expectCategoryCode(t, err, xsderrors.CategorySchemaCompile, xsderrors.CodeSchemaLimit)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	mustNotValidate(t, engine, `<r><a>x</a><c>z</c></r>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	mustNotValidate(t, engine, `<r><a>x</a><c>z</c></r>`, xsderrors.CodeValidationElement)
	mustNotValidate(t, engine, `<r><b>y</b><c>z</c></r>`, xsderrors.CodeValidationElement)
	mustNotValidate(t, engine, `<r><a>x</a><b>y</b><a>x</a><b>y</b><a>x</a><b>y</b><c>z</c></r>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	mustValidate(t, engine, `<r><c>z</c></r>`)
	mustNotValidate(t, engine, `<r><a>x</a></r>`, xsderrors.CodeValidationContent)
	mustNotValidate(t, engine, `<r><a>x</a><c>z</c></r>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="r">
	...
	mustNotValidate(t, engine, `<r/>`, xsderrors.CodeValidationContent)
	mustNotValidate(t, engine, `<r><a><b/></a></r>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="b">
	...
	mustNotValidate(t, engine, `<a/>`, xsderrors.CodeValidationAttribute)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	mustNotValidate(t, engine, `<r><a/><a/></r>`, xsderrors.CodeValidationContent)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	for _, n := range []int{1, 2} {
		mustNotValidate(t, engine, repeatedA(n), xsderrors.CodeValidationContent)
	}
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	mustNotValidate(t, engine, `<r><a/><a/><a/><b/><b/></r>`, xsderrors.CodeValidationContent)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	mustNotValidate(t, engine, repeatedAWithB(9), xsderrors.CodeValidationElement)
	mustNotValidate(t, engine, repeatedAWithB(11), xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	mustNotValidate(t, engine, repeatedA(2), xsderrors.CodeValidationContent)
	mustNotValidate(t, engine, repeatedA(4), xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	mustNotValidate(t, engine, repeatedAB(17), xsderrors.CodeValidationContent)
	mustNotValidate(t, engine, repeatedAB(19), xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	mustNotValidate(t, engine, repeatedB(1), xsderrors.CodeValidationContent)
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
	...
	mustNotValidate(t, engine, repeatedA(3), xsderrors.CodeValidationElement)
}
...
func TestLargeFiniteNestedRepeatReturnsSchemaLimit(t *testing.T) {
	_, err := xsdSchema.Compile(xsdSchema.Options{MaxContentModelStates: 8}, []source.Source{source.Bytes("schema.xsd", []byte(`
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="r">
    <xs:complexType>
      <xs:sequence>
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" targetNamespace="urn:test" xmlns:t="urn:test" elementFormDefault="qualified">
  ...
  <xs:element name="root" type="t:restricted"/>
	...
	mustNotValidate(t, engine, `<root xmlns="urn:test"><tail/></root>`, xsderrors.CodeValidationElement)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" targetNamespace="urn:f">
  <xs:attribute name="foreign" type="xs:string"/>
	...
	mustNotValidate(t, engine, `<t:root xmlns:t="urn:t" local="x"/>`, xsderrors.CodeValidationAttribute)
}
...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema">
  ...
  <xs:element name="root">
	...
	mustValidate(t, engine, `<root/>`)
	mustNotValidate(t, engine, `<root xmlns:a="urn:a" a:x="1"/>`, xsderrors.CodeValidationAttribute)
	mustNotValidate(t, engine, `<root xmlns:b="urn:b" b:x="1"/>`, xsderrors.CodeValidationAttribute)
}
...
func compiledRootModel(t *testing.T, schema string) xsdSchema.CompiledModel {
	t.Helper()
...
func TestWideChoiceIndexedDispatch(t *testing.T) {
	...
	mustNotValidate(t, engine, `<r><f0/><zzz/></r>`, xsderrors.CodeValidationElement)
	mustNotValidate(t, engine, `<r><f0/><r/></r>`, xsderrors.CodeValidationElement)
}
...
func TestWideSequenceIndexedDispatch(t *testing.T) {
  ...
  <xs:element name="r">
	...
	mustNotValidate(t, engine, `<r><f3/></r>`, xsderrors.CodeValidationContent)
	mustNotValidate(t, engine, `<r><last/><f3/></r>`, xsderrors.CodeValidationElement)
}
...
func TestWideChoiceIndexedSubstitutionGroup(t *testing.T) {
  ...
  <xs:element name="r">
	...
	mustNotValidate(t, engine, `<r><zzz/></r>`, xsderrors.CodeValidationElement)
}
...
`)
	engine := mustCompile(t, schema)
	mustNotValidate(t, engine, `<r><o:x xmlns:o="urn:o"/></r>`, xsderrors.CodeValidationElement)
}
...
func TestWideCountingExceptionDispatch(t *testing.T) {
  ...
  <xs:element name="r">
	...
	mustNotValidate(t, engine, `<r><a/><a/><a/><a/></r>`, xsderrors.CodeValidationElement)
	mustNotValidate(t, engine, `<r><a/><b/><a/></r>`, xsderrors.CodeValidationElement)
}
