...
type Schema struct {
	...
	NamespaceDecls          map[string]string          // prefix -> namespace URI from root element
	IDAttributes            map[string]string          // id value -> component description (for uniqueness validation)
	ParticleRestrictionCaps map[*types.ElementDecl]int // effective maxOccurs caps for ambiguous restrictions
