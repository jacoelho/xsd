...
func TestConcernClustersStayGrouped(t *testing.T) {
	...
	checks := []struct {
		...
		{dir: filepath.Join(root, "internal", "semantics"), prefix: "content", wantFiles: 1},
		{dir: filepath.Join(root, "internal", "semantics"), prefix: "attributes", wantFiles: 1},
		{dir: filepath.Join(root, "internal", "semantics"), prefix: "simple_types", wantFiles: 1},
		{dir: filepath.Join(root, "internal", "semantics"), prefix: "type_reference", wantFiles: 1},
		{dir: filepath.Join(root, "internal", "semantics"), prefix: "substitution", wantFiles: 1},
		{dir: filepath.Join(root, "internal", "semantics"), prefix: "particles", maxFiles: 3},
	}
