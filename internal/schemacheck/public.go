...
// ResolveFieldType exposes field XPath type resolution for reference schemacheck.
...
// ValidateRangeFacets exposes range facet consistency schemacheck.
...
// ValidateSelectorXPath exposes selector XPath schemacheck.
func ValidateSelectorXPath(xpath string) error {
	return validateSelectorXPath(xpath)
}

// ValidateFieldXPath exposes field XPath schemacheck.
