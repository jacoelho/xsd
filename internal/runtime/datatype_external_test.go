...
func TestDecimalAndIntegerCanonicalValuesDiverge(t *testing.T) {
	...
	decimal, err := rt.ValidateSimpleValue(builtinSimpleTypeID(t, rt, "decimal"), "5", nil, runtime.SimpleNeedCanonical)
	if err != nil {
	...
	integer, err := rt.ValidateSimpleValue(builtinSimpleTypeID(t, rt, "int"), "05", nil, runtime.SimpleNeedCanonical)
	if err != nil {
