...
func TestValidateSimpleContentDerivationChildren(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "restriction simple type after facet", validate: validateChildOrderForTest(simpleContentRestrictionChildOrder), children: []string{"minLength", "simpleType"}, wantIndex: 1, wantMsg: simpleContentSimpleTypeOutOfOrder},
