...
func (c *compiler) buildComplexTypePlan(registry *analysis.Registry) (*ComplexTypePlan, error) {
	if c == nil {
...
func BuildComplexTypePlan(sch *parser.Schema, registry *analysis.Registry) (*ComplexTypePlan, error) {
	if sch == nil {
