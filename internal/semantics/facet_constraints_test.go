...
func TestValidateRangeFacetsGYear(t *testing.T) {
	...
	err := ValidateRangeConsistency(nil, nil, &minInclusive, &maxInclusive, bt, bt.Name())
	if err == nil {
...
func TestValidateDurationRangeFacetsInvalidLexical(t *testing.T) {
	...
	if err := ValidateDurationRangeConsistency(&minExclusive, &maxExclusive, nil, nil); err == nil {
