...
func TestNextDerivationStepBuiltinList(t *testing.T) {
...
func TestNextDerivationStepSimpleRestrictionUsesResolver(t *testing.T) {
...
func TestNextDerivationStepComplexUsesResolvedBase(t *testing.T) {
