...
func (c *artifactCompiler) compileRegistry(registry *analysis.Registry) error {
...
func (c *artifactCompiler) compileBuiltinRegistry() error {
...
func (c *artifactCompiler) compileSimpleTypeRegistry(registry *analysis.Registry) error {
...
func (c *artifactCompiler) compileSimpleContentRegistry(registry *analysis.Registry) error {
	for _, entry := range registry.TypeOrder {
