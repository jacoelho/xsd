...
func (c *artifactCompiler) valueKeysForNormalized(lexical, normalized string, typ model.Type, ctx map[string]string) ([]runtime.ValueKey, error) {
...
func (c *artifactCompiler) keyBytesForNormalized(lexical, normalized string, typ model.Type, ctx map[string]string) ([]keyBytes, error) {
...
func (c *artifactCompiler) keyBytesForNormalizedSingle(normalized string, typ model.Type, ctx map[string]string) (keyBytes, error) {
...
func (c *artifactCompiler) keyBytesForList(normalized string, typ model.Type, ctx map[string]string) ([]keyBytes, error) {
...
func (c *artifactCompiler) keyBytesForUnion(lexical string, typ model.Type, ctx map[string]string) ([]keyBytes, error) {
