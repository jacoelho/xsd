...
func (c *artifactCompiler) collectFacets(st *model.SimpleType) ([]model.Facet, error) {
	if st == nil {
		return nil, nil
	}
...
func (c *artifactCompiler) collectFacetsRecursive(st *model.SimpleType, seen map[*model.SimpleType]bool) ([]model.Facet, error) {
	if st == nil {
		return nil, nil
	}
	if seen[st] {
...
func (c *artifactCompiler) facetsForType(typ model.Type) ([]model.Facet, error) {
