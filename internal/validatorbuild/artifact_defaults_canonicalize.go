...
func (c *artifactCompiler) canonicalizeDefaultFixed(lexical string, typ model.Type, ctx map[string]string) ([]byte, runtime.ValidatorID, runtime.ValueKeyRef, error) {
...
func (c *artifactCompiler) defaultFixedKeyRef(lexical, normalized string, typ, memberType model.Type, ctx map[string]string) (runtime.ValueKeyRef, error) {
	keyType := typ
...
func (c *artifactCompiler) canonicalizeNormalizedDefaultWithMember(lexical, normalized string, typ model.Type, ctx map[string]string) ([]byte, model.Type, error) {
