...
func (c *artifactCompiler) validatorKind(st *model.SimpleType) (runtime.ValidatorKind, error) {
...
func (c *artifactCompiler) stringKindForType(typ model.Type) runtime.StringKind {
	if c == nil || c.res == nil {
...
func (c *artifactCompiler) integerKindForType(typ model.Type) runtime.IntegerKind {
	if c == nil || c.res == nil {
