...
func (c *artifactCompiler) compileSimpleType(st *model.SimpleType) (runtime.ValidatorID, error) {
	if st == nil {
		return 0, nil
	}
...
func (c *artifactCompiler) compileSimpleTypeDependencies(st *model.SimpleType) error {
...
func (c *artifactCompiler) compileSimpleTypeValidator(st *model.SimpleType, facetRef runtime.FacetProgramRef) (runtime.ValidatorID, error) {
...
func (c *artifactCompiler) compileUnionValidator(
	st *model.SimpleType,
