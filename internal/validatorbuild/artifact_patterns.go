...
func (c *artifactCompiler) addPattern(p *model.Pattern) (runtime.PatternID, error) {
	if p.GoPattern == "" {
...
func (c *artifactCompiler) addPatternSet(set *model.PatternSet) (runtime.PatternID, error) {
