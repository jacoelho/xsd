...
func (c *artifactCompiler) compileFacetProgram(st *model.SimpleType, facets, partial []model.Facet) (runtime.FacetProgramRef, error) {
	if len(facets) == 0 {
...
func (c *artifactCompiler) compileEnumeration(enum *model.Enumeration, st *model.SimpleType, partial []model.Facet) (runtime.EnumID, error) {
	if enum == nil {
		return 0, nil
	}
	values := enum.Values()
