// Package xsd compiles XML Schema 1.0 documents into a concurrently reusable
// Engine and validates XML instance documents with isolated streaming state.
//
...
// instance documents, and resets document state before retaining bounded scratch
// for a later call.
package xsd
